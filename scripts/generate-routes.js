...
const baseUrl = 'https://utilitylab.dev/p2p-file-share';

const routes = {
  default: {
    title: 'Free P2P File Sharing - Browser-Based Secure Transfer',
    description: 'Share files peer-to-peer directly between browsers using WebRTC. No uploads, no sign-up, end-to-end connection. Large files split into chunks automatically.',
    h1: 'Free P2P File Sharing - Browser-Based Secure Transfer',
    lead: 'Share files peer-to-peer directly between browsers using WebRTC. No uploads, no sign-up, end-to-end connection. Large files split into chunks automatically.',
    schemaName: 'P2p File Share',
    schemaDesc: 'Share files peer-to-peer directly between browsers using WebRTC. No uploads, no sign-up, end-to-end connection. Large files split into chunks automatically.',
    schemaUrl: baseUrl
  }
};
